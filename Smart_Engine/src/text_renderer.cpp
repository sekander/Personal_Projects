...
TextRenderer::TextRenderer(unsigned int width, unsigned int height)
{
    ...
    //this->TextShader->SetMatrix4("projection", matrix, true);
...
void TextRenderer::RenderText(std::string text, float x, float y, float scale, glm::mat4 matrix, glm::vec3 color)
{
