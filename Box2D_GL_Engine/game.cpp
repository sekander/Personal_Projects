...
//    ResourceManager::LoadTexture("resources/images/Exit_button.png", true, "exit");
	ResourceManager::LoadTexture("resources/map/gameart2d-desert.png", true, "tiles");
    //set renderedr
...
/*
			...
			*/	
			...
			Renderer->DrawSprite(ResourceManager::GetTexture("tiles"),		//texture key 
					"ttt",
								true,
								false,
								10, 16, 0,
								glm::vec2(200, 400),	                    //Origin 
        				                        glm::vec2(640, 1024), 	                //Image size
                                				r,                                      //rotation
                                				glm::vec3(1.0f, 1.0f, 1.0f)             //colour
								);
			Renderer->DrawSprite(ResourceManager::GetTexture("tiles"),		//texture key 
